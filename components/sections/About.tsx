      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          {METRICS.map((m) => (
            <div
              key={m.label}
              className="p-6 sm:p-8 rounded-lg glass-card relative overflow-hidden group"
            >
        ...
        >
          <div className="p-8 rounded-lg glass-card border-white/[0.08] hover:border-brand-blue/40 transition-all duration-300">
            <div className="w-12 h-12 rounded-xl bg-brand-blue/10 border border-brand-blue/30 flex items-center justify-center text-brand-blue mb-6">
              <Code2 className="w-6 h-6 animate-auto-bounce" />
            </div>
          ...
          <div className="p-8 rounded-lg glass-card border-white/[0.08] hover:border-brand-violet/40 transition-all duration-300">
            <div className="w-12 h-12 rounded-xl bg-brand-violet/10 border border-brand-violet/30 flex items-center justify-center text-brand-violet mb-6">
              <Sparkles className="w-6 h-6 animate-auto-wiggle" />
            </div>
            <h3 className="text-xl font-bold text-white mb-3">
          ...
          <div className="p-8 rounded-lg glass-card border-white/[0.08] hover:border-emerald-500/40 transition-all duration-300">
            <div className="w-12 h-12 rounded-xl bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center text-emerald-400 mb-6">
              <Cpu className="w-6 h-6 animate-auto-spin" />
            </div>
            <h3 className="text-xl font-bold text-white mb-3">
